<!--Generated by WRITEME on 2023-09-12 00:35:10.334463 (UTC)-->
...
* [Analyze a document](src/main/java/com/example/textract/AnalyzeDocument.java#L65) (`AnalyzeDocument`)
* [Detect text in a document](src/main/java/com/example/textract/DetectDocumentText.java#L65) (`DetectDocumentText`)
* [Start asynchronous analysis of a document](src/main/java/com/example/textract/StartDocumentAnalysis.java#L66) (`StartDocumentAnalysis`)
