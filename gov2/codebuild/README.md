<!--Generated by WRITEME on 2023-09-12 00:35:05.017697 (UTC)-->
# CodeBuild code examples for the SDK for Go V2

## Overview

Shows how to use the AWS SDK for Go V2 to work with AWS CodeBuild.
...
* [SDK for Go V2 CodeBuild reference](https://pkg.go.dev/github.com/aws/aws-sdk-go-v2/service/codebuild)
