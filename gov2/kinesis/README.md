<!--Generated by WRITEME on 2023-09-12 00:35:05.886345 (UTC)-->
# Kinesis code examples for the SDK for Go V2

## Overview

Shows how to use the AWS SDK for Go V2 to work with Amazon Kinesis.
...
* [SDK for Go V2 Kinesis reference](https://pkg.go.dev/github.com/aws/aws-sdk-go-v2/service/kinesis)
